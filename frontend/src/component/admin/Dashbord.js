            ...
            <div className='bg-slate-800 min-h-screen flex flex-col items-center justify-center'>
                ...
                <div>
                    ...
                    <div className='grid grid-cols-1 w-[90vw] md:grid-cols-2 lg:grid-cols-3 mt-2 mb-10 mx-5 max-w-5xl text-white rounded-md bg-slate-700 p-4 gap-2 '>
                        <Link to="/user/admin/manageproduct" className='bg-orange-500 p-2 rounded-md text-center text-white font-bold'>
                            Manage Product
                        </Link>
                        <Link to="/user/admin/manageuser" className='bg-green-600 p-2 rounded-md text-center text-white font-bold'>
                            Manage Users
                        </Link>
                        <Link to="/user/admin/manageorder" className='bg-violet-700 p-2 rounded-md text-center text-white font-bold'>
                            Manage Order
                        </Link>
                        <Link to="/user/admin/managereviews" className='h-28 flex-grow rounded-md flex items-center bg-blue-800 text-white font-bold'>
                            Review
                        </Link>
